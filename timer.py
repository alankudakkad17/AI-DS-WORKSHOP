...
class stopwatch():
    ...
    def init(self):
        ...
        self.t = StringVar()
        self.t.set("00:00:00")
        self.lb = Label(self.root,textvariable=self.t,font=("Times 60 bold"),bg="white")
        ...
        self.bt1.place(x=120,y=125)
        self.bt2.place(x=220,y=125)
        self.bt3.place(x=320,y=125)
        self.bt4.place(x=420,y=125)
